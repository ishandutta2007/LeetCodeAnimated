...
The animation is produced using AE and is relatively large in size, 32M. It cannot be played using GIF, so it is played in the form of video. Please be careful on mobile phones:)

Thanks to **Jun Chen** for providing animation technical support and refills.
